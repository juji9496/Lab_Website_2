		...
		{//Outer for loop iterates over each row
			...
			if(cell_value1 > cell_value2){
				...
				counter2++;
					...
					document.getElementById("wins").innerHTML = counter1;
				document.getElementById("losses").innerHTML = counter2;
...
{
	// var arr = ["John Doe","James Smith","Samuel Phillips","Robert Myers"]
	var tags = "";
...
function switchPlayers(playerNum)
{
	...
	// document.getElementById("p_major").innerHTML = playerNUm;
	// document.getElementById("g_played").innerHTML = "Button number: " + PlayerNum + "was clicked";
	// document.getElementById("player_img").innerHTML = "Button number: " + PlayerNum + "was clicked";
